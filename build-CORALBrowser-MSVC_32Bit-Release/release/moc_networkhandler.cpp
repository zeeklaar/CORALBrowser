...
#include "../../CORALBrowser/networkhandler.h"
...
QT_MOC_LITERAL(5, 58, 8)
    ...
    "NetworkHandler\0attemptLogin\0\0recievedData\0"
    "checkConnection\0readData\0"
};
...
void NetworkHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->recievedData((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        ...
        {
            typedef void (NetworkHandler::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NetworkHandler::attemptLogin)) {
                *result = 0;
            }
        }
        {
            typedef void (NetworkHandler::*_t)(QByteArray );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NetworkHandler::recievedData)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 0
void NetworkHandler::attemptLogin()
{
    QMetaObject::activate(this, &staticMetaObject, 0, 0);
}

// SIGNAL 1
void NetworkHandler::recievedData(QByteArray _t1)
{
